...
def get_dataloader(args, scanrefer, all_scene_list, split, config, augment, scan2cad_rotation=None):
    ...
    if split == "train":
        ...
        dataloader = DataLoader(dataset, batch_size=args.batch_size, num_workers=0, sampler=data_sampler)
    else:
        dataloader = DataLoader(dataset, batch_size=args.batch_size, shuffle=True)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--stamp", type=str, help="checkpoint file name")
    ...
    parser.add_argument("--num_locals", type=int, default=10, help="Number of local objects [default: -1]")
    parser.add_argument("--num_scenes", type=int, default=-1, help="Number of scenes [default: -1]")
    parser.add_argument("--num_graph_steps", type=int, default=2, help="Number of graph conv layer [default: 0]")
